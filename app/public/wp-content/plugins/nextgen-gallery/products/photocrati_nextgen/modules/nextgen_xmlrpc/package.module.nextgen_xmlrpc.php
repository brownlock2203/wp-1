...
class C_NextGen_API extends C_Component
{
     ...
     * @return bool
     */
    function _is_valid_filename($filename)
    {
                                                ...
                                                if ($image_data_key != null) {
                                                    if (!isset($extra_data['__queuedImages'][$image_data_key])) {
                                                        if (isset($extra_data[$image_data_key])) {
                                                            ...
                                                            if ($this->_is_valid_filename($image_data_arr['tmp_name'])) {
                                                    ...
                                                    if ($image_path != NULL && $this->_is_valid_filename($image_path) && $wp_fs->exists($image_path)) {
