...
class C_Admin_Notification_Manager
{
    ...
    function enqueue_scripts()
    {
        if ($this->has_displayed_notice()) {
            ...
            wp_localize_script('ngg_admin_notices', 'ngg_notification_dismiss_settings', ['url' => $this->_dismiss_url, 'nonce' => wp_create_nonce('ngg_dismiss_notification')]);
        }
    }
    function serve_ajax_request()
    {
        ...
        if (isset($_REQUEST['ngg_dismiss_notice'])) {
            ...
            ob_start();
            if (!wp_verify_nonce($_REQUEST['nonce'], 'ngg_dismiss_notification')) {
